...
import { Trash2, Plus, GripVertical, PackagePlus, ChevronDown } from "lucide-react"
                ...
                <table className="w-full text-sm border-collapse" ref={tableRef}>
                    <thead>
                        <tr className="bg-muted/30 border-b border-border/50">
                            ...
                            <th className="text-right font-semibold text-muted-foreground px-3 py-3 w-32">Price</th>
                            <th className="text-right font-semibold text-muted-foreground px-3 py-3 w-20">Tax %</th>
                            <th className="text-right font-semibold text-muted-foreground px-3 py-3 w-[120px]">Discount</th>
                            <th className="text-right font-semibold text-muted-foreground px-3 py-3 w-32">Total</th>
                                                        ...
                                                        inventoryItems.map((inv) => (
                                                            <SelectItem key={inv.id} value={inv.id} className="cursor-pointer">
                                                                <div className="flex flex-col py-0.5">
                                                                    ...
                                                                    <span className="text-[10px] text-muted-foreground">Available Stock: {inv.stock || 0} {inv.unit || 'pcs'}</span>
                                                                </div>
                                                            </SelectItem>
                                                        ))
                                                    )}
