...
interface PropertyRowProps {
  index: number
  value: Column
  onChange: (index: number, updatedValue: Column) => void
...
export function PropertyRow({
  ...
  const update = (patch: Partial<Column>) =>
    onChange(index, { ...value, ...patch })

  const handleOptionsBlur = (e: React.FocusEvent<HTMLInputElement>) => {
