...
export function CreateTableModal({
  ...
  const getInitialCols = () =>
    initialColumns.length > 0
      ? initialColumns.map((c) =>
          makeColumn(c.name, c.type, c.mandatory, c.options),
        )
      : [makeColumn()]
  ...
  }, [open, form.reset, initialColumns.length, initialColumns.map, initialName]) // eslint-disable-line react-hooks/exhaustive-deps
