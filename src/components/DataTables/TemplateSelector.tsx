...
export function TemplateSelector({ onSelectTemplate }: TemplateSelectorProps) {
  return (
    <div className="flex flex-col gap-5">
      <div>
        <p className="text-sm font-semibold tracking-tight text-foreground/90">Choose a Template</p>
          ...
          return (
            ...
            >
              ...
              <CardHeader className="pb-3 pt-6 px-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    ...
                    <Badge
                      className="mt-2.5 w-fit text-[9px] font-semibold uppercase tracking-wider bg-muted text-muted-foreground border-none shadow-none hover:bg-muted"
                    >
                      {template.category}
                    </Badge>
                  </div>
              ...
              <CardContent className="px-5 pb-5 pt-1 flex items-center justify-between gap-3 border-t border-border/20 mt-2 bg-muted/10 dark:bg-muted/5">
                <Badge variant="outline" className="text-[10px] font-medium text-muted-foreground/80 bg-background/50 border-border/40 px-2 py-0.5 rounded-md">
