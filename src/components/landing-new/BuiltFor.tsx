...
export function BuiltFor() {
  const segments = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1640181637089-cce4a3040ed2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRhaWwlMjBzaG93cm9vbSUyMGJ1c2luZXNzJTIwc3RhZmYlMjBpbmRpYXxlbnwxfHx8fDE3NzEyMzkxNTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      title: "Distributors",
