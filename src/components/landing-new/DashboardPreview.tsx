      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl p-8">
          ...
          <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-200">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900">Business Dashboard</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-md">
              ...
              <div className="text-3xl font-semibold text-gray-900 mb-3">₹2.1L</div>
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-md relative overflow-hidden">
              ...
              <div className="absolute bottom-2 right-2 w-16 h-16 opacity-30">
                <svg viewBox="0 0 36 36" className="w-full h-full">
                  ...
                  <circle cx="18" cy="18" r="16" fill="none" stroke="#0a4a5c" strokeWidth="3" strokeDasharray="75 25" transform="rotate(-90 18 18)" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
              <h4 className="font-semibold text-gray-900 mb-4">Invoice Status</h4>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-semibold text-gray-900">324 (67%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-green-500 to-green-600 h-3 rounded-full shadow-sm" style={{ width: '67%' }}></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-semibold text-gray-900">127 (26%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-amber-500 to-amber-600 h-3 rounded-full shadow-sm" style={{ width: '26%' }}></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-semibold text-gray-900">35 (7%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-red-500 to-red-600 h-3 rounded-full shadow-sm" style={{ width: '7%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600">Raj Traders • ₹24,500</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600">M/s Sharma & Co • ₹18,200</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600">Gupta Enterprises • ₹42,300</p>
          ...
          {/* Compact Table */}
          <div className="space-y-4">
            <h4 className="font-semibold text-gray-900 text-lg">Recent Invoices</h4>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {[
                      { customer: "Raj Traders", amount: "₹24,500", date: "15 Feb", status: "Paid" },
                      { customer: "M/s Sharma & Co", amount: "₹18,200", date: "14 Feb", status: "Pending" },
                      { customer: "Krishna Distributors", amount: "₹32,100", date: "13 Feb", status: "Paid" },
                      { customer: "Patel Medical", amount: "₹15,800", date: "12 Feb", status: "Paid" },
                    ].map((invoice, index) => (
