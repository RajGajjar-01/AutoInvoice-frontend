            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col divide-y rounded-xl border overflow-hidden">
                    {ALL_METHODS.map((method) => {
                        const isConnected =
                            method.alwaysConnected || !!connected[method.id];
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {method.alwaysConnected || method.comingSoon ? (
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    <AlertDialogTitle>Disconnect {method.label}?</AlertDialogTitle>
                                                    <AlertDialogDescription>
                                                        You will no longer be able to sign in using {method.label}.
                                                        Make sure you have another login method available.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
