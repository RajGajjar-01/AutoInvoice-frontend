        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-muted-foreground max-w-md">
                    Download all your data including invoices, tables, and settings as a ZIP file.
                </p>
                <Button variant="outline" size="sm" className="self-start" onClick={handleExport}>
                    Export Data
                </Button>
            </div>
                ...
                <AlertDialog>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Your account will be temporarily disabled. Log in again to reactivate.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
