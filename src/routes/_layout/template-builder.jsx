      ...
      return (
        <div style={base}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 38, height: 38, borderRadius: 8, background: accent, color: "#fff", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, flexShrink: 0 }}>UD</div>
            <div>
              <p style={{ fontWeight: 700, fontSize: 14, margin: 0 }}>UnifiedDesk Pvt Ltd</p>
    ...
    case "footer":
      return (
        <div style={{ ...base, borderTop: "1px solid #e5e7eb", textAlign: "center", color: "#9ca3af", fontSize: 11 }}>
          Thank you for your business · Generated by UnifiedDesk
        </div>
      )
    default:
  ...
  const handlePreview = useCallback(() => {
    ...
    const blockHtml = (block) => {
      ...
      switch (block.type) {
        ...
        case "footer":
          return `<div ${wrap} style="${wrap.slice(7, -1)};border-top:1px solid #e5e7eb;text-align:center;color:#9ca3af;font-size:11px">Thank you for your business &bull; Generated by UnifiedDesk</div>`
        default: return ""
      }
    }
