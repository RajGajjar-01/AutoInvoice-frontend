...
const builtInTemplates: BuiltInTemplate[] = [
  {
    ...
    name: "Clean Teal",
    description:
      "Bold teal heading with From/Bill To columns and a note footer",
    icon: FileText,
  ...
  },
  {
    ...
    name: "Circle Studio",
    description:
      "Minimalist black and white with centered logo and thank-you script",
    icon: Receipt,
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "28px 28px 0", flex: 1 }}>
        ...
        >
          ...
          >
            <div style={{ marginBottom: 3 }}>
              <span style={{ color: "#94a3b8" }}>Date:</span> 12/07/2025
            </div>
            <div style={{ marginBottom: 3 }}>
              <span style={{ color: "#94a3b8" }}>Invoice No:</span> 123456789
            </div>
            <div>
              <span style={{ color: "#94a3b8" }}>Due:</span> 11/08/2025
            </div>
          </div>
        </div>
        {/* FROM / BILL TO */}
        ...
        >
          <div>
            ...
            <p style={{ color: "#64748b", fontSize: 9, marginTop: 2 }}>
              123-456-7890
            </p>
          ...
          <div>
            ...
            <p style={{ color: "#64748b", fontSize: 9 }}>
              456 Client Ave., Metro City, ST 54321
            </p>
        ...
        >
          <thead>
            <tr style={{ background: "#0E7490", color: "#fff" }}>
              <th
                style={{ padding: "7px 8px", textAlign: "center", width: 30 }}
              >
                SL
              </th>
              ...
              <th style={{ padding: "7px 10px", textAlign: "right" }}>
                Amount
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr
              style={{ borderTop: "2px solid #0E7490", background: "#f0fdfe" }}
            >
              <td
                colSpan={2}
                style={{
        ...
        >
          <strong style={{ color: "#1a1a1a" }}>Note:</strong> Please send
          payment within 30 days. Late payments attract 10% interest/month.
        </div>
        {/* Bank details */}
        <div style={{ marginTop: 10, fontSize: 9, color: "#64748b" }}>
          Bank: HDFC &nbsp;|&nbsp; A/C: 0012345678 &nbsp;|&nbsp; IFSC:
          HDFC0000123
        </div>
      </div>
      {/* Footer */}
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 8 }}>
    ...
    >
      ...
      <div
        style={{
          ...
          borderBottom: "56px solid #EC4899",
        }}
      />
      {/* Body */}
      <div style={{ padding: "28px 28px 0", flex: 1 }}>
        ...
        >
          <div style={{ fontSize: 10, color: "#555" }}>
            <p style={{ marginBottom: 3 }}>
              <span style={{ color: "#94a3b8" }}>Date Issued:</span> 01 January
              2025
            </p>
            <p style={{ marginBottom: 3 }}>
              <span style={{ color: "#94a3b8" }}>Invoice No:</span> 01234
            </p>
            <p>
              <span style={{ color: "#94a3b8" }}>Due Date:</span> 31 January
              2025
            </p>
          </div>
        ...
        >
          <thead>
            ...
            >
              <th
                style={{ padding: "8px 8px", textAlign: "center", width: 30 }}
              >
                NO
              </th>
          ...
          <tbody>
            {[
              [1, "Design Work", 1, "$100", "$200"],
              [2, "Development", 2, "$50", "$100"],
              [3, "Consulting", 1, "$80", "$80"],
            ].map(([n, d, q, p, s], i) => (
              <tr
                key={i}
                style={{
        ...
        >
          <div style={{ fontSize: 9, color: "#64748b" }}>
            <p style={{ fontWeight: 700, color: "#1a1a1a", marginBottom: 2 }}>
              Bank Details
            </p>
...
function CircleStudioPreview(): React.ReactNode {
  return (
    ...
    >
      ...
      <div style={{ padding: "24px 28px 0", flex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          ...
          >
            ...
            <span style={{ fontWeight: 900, fontSize: 9, letterSpacing: 3 }}>
              CIRCLE
            </span>
            <span
              style={{
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <p
              style={{ fontWeight: 900, fontSize: 20, fontFamily: "monospace" }}
            >
              #012345
            </p>
            <p style={{ color: "#6b7280", fontSize: 9, marginTop: 3 }}>
              12.06.2024
            </p>
        ...
        >
          ...
          <tbody>
            {[
              ["Logo Design", 200, 1, "$200"],
              ["Brand Guide", 150, 1, "$150"],
              ["Social Kit", 100, 2, "$200"],
              ["Consultation", 80, 1, "$80"],
              ["Revisions", 60, 1, "$60"],
            ].map(([d, p, q, t], i) => (
        ...
        >
          <span>TOTAL</span>
          <span style={{ fontFamily: "monospace" }}>$690</span>
        </div>
        {/* Bank + Thank you */}
        <div
          style={{
      ...
      >
        <p style={{ color: "#6b7280", fontSize: 9, fontStyle: "italic" }}>
          We appreciate your business
        </p>
        <p style={{ color: "#9ca3af", fontSize: 8 }}>
          Generated by AutoInvoice
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <p style={{ fontWeight: 900, fontSize: 13, lineHeight: 1.1 }}>
            AIZEN COMPANY
          </p>
          <p
            style={{
      ...
      >
        ...
        <div style={{ textAlign: "right" }}>
          ...
          <p style={{ fontWeight: 700, color: "#ef4444", marginTop: 3 }}>
            USD: $1,500
          </p>
        </div>
      </div>
      ...
      <div style={{ padding: "0 24px", flex: 1 }}>
        ...
        >
          ...
          <tbody>
            {[
              ["Brand Identity Design", 2, "$120", "$240"],
              ["Social Media Package", 4, "$100", "$400"],
              ["Website Mockup", 2, "$120", "$240"],
              ["Content Strategy", 1, "$380", "$380"],
              ["Consultation", 3, "$80", "$240"],
            ].map(([d, q, p, t], i) => (
              <tr
                key={i}
                style={{
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "#fff", fontWeight: 700, fontSize: 11 }}>
            Your Business
          </p>
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: 9 }}>
      ...
      <div
        style={{
          background: "#eef1f7",
          padding: "6px 28px",
          borderBottom: "1px solid #dce1ed",
          fontSize: 9,
          color: "#6b7280",
        }}
      >
        <span style={{ fontWeight: 700, color: "#1e2d5b" }}>Your Business</span>{" "}
        &nbsp;|&nbsp; 123 Anywhere St., Any City &nbsp;|&nbsp; GSTIN:
        27XXXXX1234
      </div>
      {/* Body */}
      <div style={{ padding: "20px 28px", flex: 1 }}>
        ...
        >
          <div>
            ...
            <p style={{ fontWeight: 700, fontSize: 11, color: "#1e2d5b" }}>
              Global Corp Ltd.
            </p>
            <p style={{ color: "#6b7280", fontSize: 9, marginTop: 2 }}>
              456 Corporate Blvd, Metro City
            </p>
          ...
          <div>
            ...
            <table style={{ fontSize: 9, borderCollapse: "collapse" }}>
              <tbody>
                ...
                <tr>
                  <td style={{ color: "#6b7280", paddingBottom: 3 }}>
                    Currency
                  </td>
                  <td style={{ color: "#1e2d5b" }}>INR</td>
                </tr>
                <tr>
                  <td style={{ color: "#6b7280", paddingBottom: 3 }}>
                    PO Number
                  </td>
                  <td style={{ color: "#1e2d5b", fontFamily: "monospace" }}>
                    PO-0042
                  </td>
                </tr>
              </tbody>
        ...
        >
          ...
          <tbody>
            {[
              [1, "Strategy Consulting", 1, "₹25,000", "₹25,000"],
              [2, "UI/UX Design", 3, "₹5,000", "₹15,000"],
              [3, "Development", 2, "₹10,000", "₹20,000"],
            ].map(([n, d, q, p, a], i) => (
              <tr
                key={i}
                style={{
...
interface ServerTemplate {
  id: string
  name: string
  kind: "built_in" | "custom" | "imported_html" | "imported_pdf"
  built_in_id?: string
  custom_data?: {
    blocks?: unknown[]
    savedAt: string
  }
  imported_pdf_data_url?: string
...
function InvoiceTemplatesPage() {
  ...
  const selectedTemplate: string =
    (activeTemplate as ActiveTemplate)?.kind === "built_in"
      ? ((activeTemplate as ActiveTemplate)?.built_in_id ?? "clean-teal")
      : (activeTemplate as ActiveTemplate)?.kind === "custom"
        ? "custom"
        : (activeTemplate as ActiveTemplate)?.kind === "imported_html" ||
            (activeTemplate as ActiveTemplate)?.kind === "imported_pdf"
          ? "imported"
          : "clean-teal"
  ...
  const importedTemplate: ImportedTemplate | null = serverImportedTemplate
    ? serverImportedTemplate.kind === "imported_pdf"
      ? {
          type: "pdf",
          dataUrl: serverImportedTemplate.imported_pdf_data_url,
          name: serverImportedTemplate.name,
          savedAt: serverImportedTemplate.updated_at ?? "",
        }
      : {
          type: "html",
          html: serverImportedTemplate.imported_html,
          name: serverImportedTemplate.name,
          savedAt: serverImportedTemplate.updated_at ?? "",
        }
    : null
    ...
    try {
      if (id === "custom") {
        if (!serverCustomTemplate) {
          showErrorToast(
            "No custom template found. Create one in Template Builder first.",
          )
          return
        }
        await activateTemplateMutation.mutateAsync({
          id: serverCustomTemplate.id,
        })
      ...
      if (id === "imported") {
        if (!serverImportedTemplate) {
          showErrorToast(
            "No imported template found. Upload or paste HTML first.",
          )
          return
        }
        await activateTemplateMutation.mutateAsync({
          id: serverImportedTemplate.id,
        })
      ...
      try {
        if (isPdf) {
          await createTemplateMutation.mutateAsync({
            ...
            kind: "imported_pdf",
            imported_pdf_data_url: result as string,
            is_active: true,
          })
        } else {
          await createTemplateMutation.mutateAsync({
            ...
            kind: "imported_html",
            imported_html: result as string,
            is_active: true,
          })
        }
  ...
  const handlePasteSubmit = () => {
    ...
    if (!trimmed) {
      showErrorToast("Please paste some HTML first")
      return
    }
    if (!trimmed.includes("<")) {
      showErrorToast("That doesn't look like valid HTML")
      return
    }
  ...
  const handlePreviewImported = () => {
    ...
    if (importedTemplate.type === "pdf") {
      ...
      if (!popup) {
        showErrorToast("Allow popups to preview")
        return
      }
    ...
    <div className="flex flex-col gap-6">
              ...
              <CardContent className="pb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="flex-1"
                    variant={
                      selectedTemplate === tpl.id ? "secondary" : "default"
                    }
      ...
      <div className="mt-2">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Have an existing HTML invoice template? Upload the file or paste the
          HTML directly to use it here.
        </p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground">
                      Imported{" "}
                      {new Date(importedTemplate.savedAt).toLocaleDateString()}
                    </p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="pb-4 space-y-2">
                ...
                <div className="flex gap-2 pt-1">
                  ...
                  <Button
                    ...
                    className="flex-1"
                    variant={
                      selectedTemplate === "imported" ? "secondary" : "default"
                    }
            ...
            <CardContent className="py-6 px-5 space-y-4">
              <div className="text-center mb-2">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Upload a <strong>PDF</strong> or <strong>HTML</strong> file,
                  or paste HTML code
                </p>
              </div>
          ...
          <Card className="border-dashed hover:border-primary/40 hover:shadow-md transition-all duration-200">
            <CardContent className="py-6 px-5 space-y-4">
              <div className="text-center mb-2">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Upload an <strong>Excel file</strong> with invoice line items
              ...
              <p className="text-xs text-center text-muted-foreground">
                Auto-detects: Item, Qty, Price, Tax, Invoice #, Date, Customer
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      >
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <Button
              onClick={() => {
                if (previewTemplate) handleSelectTemplate(previewTemplate.id)
